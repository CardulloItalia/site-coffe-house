        ...
        <div className="w-full flex flex-row justify-center items-center mt-20 mb-30 ">
            ...
            <div className="flex flex-row -space-x-50">
                <div className="flex flex-col gap-1">
                    <div className="w-[374px] h-[579px] rounded-3xl">
                        <img src="https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="photo3" className="w-full h-full object-cover rounded-3xl" />
                    </div>
                ...
                <div className="flex flex-col relative rotate-12 gap-1">
                    ...
                    <div className="w-[347.64px] h-[539.47px] bg-blue-night rounded-3xl z-10">
                        <img src="https://images.unsplash.com/photo-1532003955843-63df21692c76?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="photo2" className="w-full h-full object-cover rounded-3xl" />
                    </div>
                </div>
            </div>
        </div>
